...
// WINDOW
  ...
  wnd_AntiZombi  : procedure; //убирает окно зомби  [[[[[[[[[[[[[[[
...
var
  mouse_real_X     : function : Longint;     //[[[[[[[[[[[[[[[[[[[
  mouse_real_Y     : function : Longint;     //[[[[[[[[[[[[[[[[[[[
  mouse_SetPos     : procedure(X,Y:longint); //[[[[[[[[[[[[[[[[[[[
...
//[[[[[[[[[[[[[[[[[[[[[[[[[  ssprite2d_Draw : procedure( Texture : zglPTexture; X, Y, W, H, Angle : Single; Alpha : Byte = 255; FX : LongWord = FX_BLEND );
  ssprite2d_Draw : procedure(Okruglenie : Byte; Texture : zglPTexture; X, Y, W, H, Angle : Single; Alpha : Byte = 255; FX : LongWord = FX_BLEND );
...
//zgl_log  //[[[[[[[[[[[[[[[[[[
var
  stavitj_putj_igry : procedure (s5: ansistring);//[[[[[[[[[[[[[[[[[
  tjanutj_putj_igry : function: ansistring;//[[[[[[[[[[[[[[[[[
...
type
  ...
  zglTEmitter2D = record
    ...
    const  //[[[[[[[[[[[[[[[[[[[[[[
    Modifikator: Byte=0; //[[[[[[[[[[[[[[[[[[[[  0=умолчание, 1=рисовка в одну линию
    var  //[[[[[[[[[[[[[[[[[[[[[[
    ID         : Integer;
    Type_      : Byte;
    Params     : record
...
var
  ...
  emitter2d_Draw2          : procedure( Emitter : zglPEmitter2D{; X,Y: EXTENDED }); //[[[[[[[[[[[[[[[[[[ 
...
//  snd_Play2           : function( Sound : zglPSound; Loop : Boolean = FALSE; X : Single = 0; Y : Single = 0; Z : Single = 0; Volume : Single = SND_VOLUME_DEFAULT ) : Integer;//[[[[[[[[[[[[[[[[[[[
...
begin
  ...
  if zglLib <> {$IFDEF UNIX} nil {$ENDIF} {$IFDEF WINDOWS} 0 {$ENDIF} Then
    begin
      ...
      wnd_AntiZombi := dlsym( zglLib, 'wnd_ShowCursor' ); //[[[[[[[[[[[[[[
      ...
      stavitj_putj_igry := dlsym( zglLib, 'stavitj_putj_igry' );//[[[[[[[[[[[[[[[[[
      tjanutj_putj_igry := dlsym( zglLib, 'tjanutj_putj_igry' );//[[[[[[[[[[[[[[[[[

      mouse_real_X := dlsym( zglLib, 'mouse_real_X' );  //[[[[[[[[[[[[[[[[[[[
      mouse_real_Y := dlsym( zglLib, 'mouse_real_Y' );  //[[[[[[[[[[[[[[[[[[[
      mouse_SetPos := dlsym( zglLib, 'mouse_SetPos' );  //[[[[[[[[[[[[[[[[[[[
      ...
      emitter2d_Draw2 := dlsym( zglLib, 'emitter2d_Draw' );  //[[[[[[[[[[[[[[[[
...
//      snd_Play2 := dlsym( zglLib, 'snd_Play2' );
