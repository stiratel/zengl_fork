...
procedure ssprite2d_Draw(Okruglenie : Byte; Texture : zglPTexture; X, Y, W, H, Angle : Single; Alpha : Byte = 255; FX : LongWord = FX_BLEND );//[[[[[[[[[[[[[[[[[[[[[[[[[[[[[
//Okruglenie = 0 - координаты X и Y без изменений, = 1 - trunc реальных координат, = 2 - round реальных координат
