...
procedure emitter2d_FreeT( var Emitter : zglTEmitter2D ); //[[[[[[[[[[[[[[[[[[[[[ИСПОЛЬЗОВАНИЕ ВИСНЕТ
procedure emitter2d_Draw2( Emitter : zglPEmitter2D{; X,Y: EXTENDED }); //[[[[[[[[[[[[[[[[[[
...
procedure emitter2d_FreeT( var Emitter : zglTEmitter2D ); //[[[[[[[ИСПОЛЬЗОВАНИЕ ВИСНЕТ[[[[[[[[[[[[[[vvvvvvvvvvvvvv
begin
 // if not Assigned( @Emitter ) Then exit;
  ...
  FreeMem( @Emitter );
  //Emitter := nil; с такой переменной такая операция не работает
 // Dispose( @Emitter ); 
end; //[[[[[[[[[[[[[[[[[[[[[[^^^^^^^^^^^^^^^
        ...
        begin
          ...
          for i := 0 to Particles - 1 do
            begin
             ...
             // p.Position.X:=X;
             // p.Position.Y:=Y;
              p.Position.X:=EMITTER.PARAMS.POSITION.X;//[[[[[[[[[[[[[[[[[[
              p.Position.Y:=EMITTER.PARAMS.POSITION.Y;//[[[[[[[[[[[
              tc := @ParParams.Texture.FramesCoord[ p.Frame ];
...
//[[[[[[[[[[[[[[[[[          p.SizeS.X    := ParParams.SizeXS + Random( Round( ParParams.SizeXV * 1000 ) ) / 1000 - ParParams.SizeXV / 2;
          case Modifikator of  //[[[[[[[[[[[[[[[[[[[[[[
          1: p.SizeS.X := ParParams.SizeXS;
          else p.SizeS.X := ParParams.SizeXS + Random( Round( ParParams.SizeXV * 1000 ) ) / 1000 - ParParams.SizeXV / 2;
          end;
  ...
  //[[[[[[[[[[[[[[[[[[[            p.SizeS.Y  := ParParams.SizeYS + Random( Round( ParParams.SizeYV * 1000 ) ) / 1000 - ParParams.SizeYV / 2;
               case Modifikator of  //[[[[[[[[[[[[[[[[[[[[[[
               1: p.SizeS.Y  := ParParams.SizeYS;
               else p.SizeS.Y  := ParParams.SizeYS + Random( Round( ParParams.SizeYV * 1000 ) ) / 1000 - ParParams.SizeYV / 2;  
               end;
          p.Size.X     := p.SizeS.X;
          p.Size.Y     := p.SizeS.Y;
...
//[[[[[[[[[[[[[[[[[[[[[          p.Spin       := ParParams.SpinS + Random( Round( ParParams.SpinV * 1000 ) ) / 1000 - ParParams.SpinV / 2;
          case Modifikator of  //[[[[[[[[[[[[[[[[[[[[[[
          1: p.Spin := ParParams.SpinS;
          else p.Spin := ParParams.SpinS + Random( Round( ParParams.SpinV * 1000 ) ) / 1000 - ParParams.SpinV / 2;
          end;
