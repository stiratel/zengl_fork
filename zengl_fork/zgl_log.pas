...
procedure stavitj_putj_igry(s5: ansistring);//[[[[[[[[[[[[[[[[[
function  tjanutj_putj_igry : ansistring;//[[[[[[[[[[[[[[[[[

var
  log      : zglTFile = FILE_ERROR;
  logStart : LongWord;
  logFile  : PAnsiChar;
  putj_igry : ansistring;//[[[[[[[[[[[[[[ изменено
...
//[[[[[[[[[[[[[[[     logFile := utf8_GetPAnsiChar( 'log.txt' )
    logFile := utf8_GetPAnsiChar( putj_igry + 'log.txt' )//[[[[[[[[[[[[[[[[[[
  {$ENDIF}
  {$IFDEF WINDESKTOP}
  if not Assigned( logFile ) Then
//[[[[[[[[[[[[[[[     logFile := utf8_GetPAnsiChar( 'log.txt' )
